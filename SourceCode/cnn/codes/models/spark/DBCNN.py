...
pos = pd.read_csv('../../../../data/spark/pos.csv')
neg = pd.read_csv('../../../../data/spark/neg.csv')
sim = pd.read_csv('../../../../data/spark/spark_sim.csv')
sim = sim[['sim', 'label', 'pair_id']]
result_path = 'E:/Documents/project/pythonProject6/cnn/codes/models/spark/'
