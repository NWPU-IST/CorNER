...
pos = pd.read_csv('../../../../data/thunderbird/pos.csv')
neg = pd.read_csv('../../../../data/thunderbird/neg.csv')
sim = pd.read_csv('../../../../data/thunderbird/thunderbird_sim.csv')
sim = sim[['sim', 'label', 'pair_id']]
result_path = 'E:/Documents/project/pythonProject6/cnn/codes/models/thunderbird/'
...
sim = sim[['sim', 'label', 'pair_id', 'same_tw', 'same_comp', 'Title_1', 'Title_2', 'Issue_id_1', 'Issue_id_2']]
# print(sim.shape)
