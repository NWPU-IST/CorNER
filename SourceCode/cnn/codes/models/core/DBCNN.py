...
pos = pd.read_csv('../../../../data/core/pos.csv')
neg = pd.read_csv('../../../../data/core/neg.csv')
sim = pd.read_csv('../../../../data/core/core_sim.csv')
sim = sim[['sim', 'label', 'pair_id']]
result_path = 'E:/Documents/project/pythonProject6/cnn/codes/models/core/'
...
sim = sim[['sim', 'label', 'pair_id', 'Title_1', 'Title_2', 'Issue_id_1', 'Issue_id_2']]
# print(sim.shape)
