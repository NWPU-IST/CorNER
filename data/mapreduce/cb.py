...
pos = pd.read_csv('../../../../data/mapreduce/pos.csv')
neg = pd.read_csv('../../../../data/mapreduce/neg.csv')
sim = pd.read_csv('../../../../data/mapreduce/mapreduce_sim.csv')
